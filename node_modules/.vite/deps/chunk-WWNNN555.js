import {
  ...
  Transition_default
} from "./chunk-GO2PTX6K.js";
import {
  getUnit,
  toUnitless
} from "./chunk-MDPSVVB4.js";
import {
  require_react_dom
  ...
  return (0, import_jsx_runtime29.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime29.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime29.jsx)(Typography_default, {
        color: "textSecondary",
        children
      }) : (0, import_jsx_runtime29.jsxs)(React37.Fragment, {
...
var OutlinedInput = React51.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime42.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime42.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime42.jsxs)(React51.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var Select = React55.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime46.jsx)(React55.Fragment, {
...
var Tab = React57.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React57.isValidElement(iconProp) ? React57.cloneElement(iconProp, {
    className: clsx_default(classes.icon, iconProp.props.className)
  }) : iconProp;
  const handleClick = (event) => {
  ...
  return (0, import_jsx_runtime48.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime48.jsxs)(React57.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime48.jsxs)(React57.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
var TabScrollButton = React60.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
...
var Tabs = React62.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React62.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React62.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React62.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React62.useState(false);
  const [scrollerStyle, setScrollerStyle] = React62.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React62.useRef(null);
  const tabListRef = React62.useRef(null);
  const externalForwardedProps = {
    slots,
    slotProps: {
  ...
  const handleScrollbarSizeChange = React62.useCallback((scrollbarWidth) => {
  ...
  let childIndex = 0;
  const children = React62.Children.map(childrenProp, (child) => {
...
//# sourceMappingURL=chunk-WWNNN555.js.map
